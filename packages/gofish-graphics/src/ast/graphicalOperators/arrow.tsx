...
export const arrow = (...args: unknown[]) => {
  const { opts, children } = processOperatorArgs<ArrowOpts>(args);
          ...
          intrinsicDims: [
            {
              ...
              center:
                combinedBBox.minX + (combinedBBox.maxX - combinedBBox.minX) / 2,
            ...
            },
            {
              ...
              center:
                combinedBBox.minY + (combinedBBox.maxY - combinedBBox.minY) / 2,

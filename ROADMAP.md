...
## Our Vision
We envision a world where researchers communicate technical information with representations --- graphics, presentations, computational documents --- that are expressive, alive, and deeply creative.
...
While in the long-term we are interested in helping all of these folks, **in the short term we want to pick a single beachhead market to start with.**

Our current target market are **biologists.**

The characteristics of the beachhead market are:
...
Biologists are a natural subgroup within this market, because they make lots of bespoke graphics, which need to look nice for prestigious journals like _Science_ and _Nature_. Helping biologists allows us to tackle adjacent markets of other scientists and engineers later.
